...
#ifndef __MPAM_ACS_COMMON_H__
#define __MPAM_ACS_COMMON_H__

#define ACS_CACHE_TEST_NUM_BASE     0
#define ACS_CSUMON_TEST_NUM_BASE    20
#define ACS_INTR_TEST_NUM_BASE      30
#define ACS_MEMORY_TEST_NUM_BASE    40
...
#define ACS_TEST_START(test_num)    (((TEST_START_VAL) << STATE_BIT) | ((test_num) << TEST_NUM_BIT))
#define ACS_TEST_END(test_num)      (((TEST_END_VAL) << STATE_BIT) | ((test_num) << TEST_NUM_BIT))
