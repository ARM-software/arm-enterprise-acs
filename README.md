...
This repository is deprecated. All support for the repository will end on 31st October 2022 after which it shall be archived. Refer to [Arm SystemReady SR ACS](https://github.com/ARM-software/arm-systemready/tree/main/SR) for the new ACS.
...
- [Server Base System Architecture (SBSA)](https://github.com/ARM-software/sbsa-acs) TAG: v21.10_REL3.1.1
