...
#define TEST_DESC "Verify always availability- PE_UNMASK          "
...
/* Check the SDEI_PE_UNMASK API in below states
...
SDEI_SET_TEST_DEPS(test_037_deps, TEST_001_ID, TEST_002_ID);
SDEI_PUBLISH_TEST(test_037, TEST_037_ID, TEST_DESC, test_037_deps, test_entry, FALSE);
