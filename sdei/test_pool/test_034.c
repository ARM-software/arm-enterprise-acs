...
#define TEST_DESC "Verify always availability- SDEI_FEATURES      "
...
/* Check the SDEI_FEATURES API in below states
...
SDEI_SET_TEST_DEPS(test_034_deps, TEST_001_ID, TEST_002_ID);
SDEI_PUBLISH_TEST(test_034, TEST_034_ID, TEST_DESC, test_034_deps, test_entry, FALSE);
