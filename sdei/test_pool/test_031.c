...
#define TEST_DESC "Verify check always availability- VERSION      "
...
/* Check the SDEI_VERSION API in below states
...
static void event_handler(void)
{
    ...
    err = val_sdei_get_version(&result);
    if (err) {
...
SDEI_SET_TEST_DEPS(test_031_deps, TEST_001_ID, TEST_002_ID);
SDEI_PUBLISH_TEST(test_031, TEST_031_ID, TEST_DESC, test_031_deps, test_entry, FALSE);
