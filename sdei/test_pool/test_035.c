...
#define TEST_DESC "Verify always availability- SDEI_SHARED_RESET  "
...
/* Check the SDEI_SHARED_RESET API in below states
...
SDEI_SET_TEST_DEPS(test_035_deps, TEST_001_ID, TEST_002_ID);
SDEI_PUBLISH_TEST(test_035, TEST_035_ID, TEST_DESC, test_035_deps, test_entry, FALSE);
