...
#define TEST_DESC "Verify SDEI event register test                 "
#define SDEI_UNKNOWN_EVENT 0x10000
#define REGISTERED 0x1

/* This function verifies the shared and private events register to Dispatcher.
 * it also checks event register error checks.
 */
...
static void test_entry(void)
{
    ...
    ret = val_sdei_event_register(SDEI_UNKNOWN_EVENT, (uint64_t)asm_event_handler, NULL, 0, 0);
...
SDEI_SET_TEST_DEPS(test_003_deps, TEST_NONE_ID);
SDEI_PUBLISH_TEST(test_003, TEST_003_ID, TEST_DESC, test_003_deps, test_entry, TRUE);
