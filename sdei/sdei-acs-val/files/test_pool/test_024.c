...
#define TEST_DESC "Verify SDEI_EVENT_COMPLETE Call                "
...
static void event_handler_shared(void)
{
...
SDEI_SET_TEST_DEPS(test_024_deps, TEST_001_ID, TEST_002_ID);
SDEI_PUBLISH_TEST(test_024, TEST_024_ID, TEST_DESC, test_024_deps, test_entry, FALSE);
