...
#ifndef __VAL_TIMER_H
#define __VAL_TIMER_H
...
uint64_t ArmReadCntFrq (void);
void ArmWriteCntFrq (uint64_t FreqInHz);
uint64_t ArmReadCntPct (void);

uint64_t ArmReadCntkCtl (void);
void ArmWriteCntkCtl (uint64_t Val);
uint64_t ArmReadCntpTval (void);
void ArmWriteCntpTval (uint64_t Val);

uint64_t ArmReadCntpCtl (void);
void ArmWriteCntpCtl (uint64_t Val);
uint64_t ArmReadCntvTval (void);
void ArmWriteCntvTval (uint64_t Val);

uint64_t ArmReadCntvCtl (void);
